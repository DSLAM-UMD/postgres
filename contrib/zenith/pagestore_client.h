...
extern bool zenith_slru_kind_check(SlruCtl ctl);
extern bool zenith_slru_read_page(SlruCtl ctl, int segno, off_t offset, char *buffer);
extern bool zenith_slru_page_exists(SlruCtl ctl, int segno, off_t offset);
